...
(function () {
  ...
  var SHELVES = [
    { id: 'conquest',
      ...
      books: [
        ...
        { y: '1681', c: C.leather, h: 'tall', url: 'https://archive.org/details/recopilaciondele01spai_1',
        ...
        { y: '1601', c: C.moss, h: 'tall', url: 'https://archive.org/details/historiagenerald12herr',
        ...
        { y: '1726', c: C.tan, url: 'https://archive.org/details/historiagenerald04herr',
        ...
        { y: '1847', c: C.teal, url: 'https://archive.org/details/selectlettersofc00colurich',
    ...
    { id: 'handover',
      ...
      books: [
        ...
        { y: '1899', c: C.slate, url: 'https://archive.org/details/peaceusspain00presrich',
        ...
        { y: '1900', c: C.rust, h: 'tall', url: 'https://archive.org/details/reportonislandof00unit',
        ...
        { y: '1903', c: C.moss, url: 'https://archive.org/details/reportcommissio09educgoog',
  ...
  function render() {
    ...
    SHELVES.forEach(function (sh) {
      ...
      sh.books.forEach(function (b) {
        ...
        btn.className = 'book' + (b.h ? ' ' + b.h : '') + (b.url ? ' offsite' : '');
  ...
  var LBL = {
    en: { open: 'Open full page', close: 'Close', off: 'This volume is held in the project archive but is too large to serve from this site. It opens at the institution that scanned it.' },
    es: { open: 'Abrir página completa', close: 'Cerrar', off: 'Este tomo está en el archivo del proyecto pero es demasiado grande para servirse desde este sitio. Se abre en la institución que lo escaneó.' },
    ru: { open: 'Открыть страницу целиком', close: 'Закрыть', off: 'Этот том хранится в архиве проекта, но слишком велик для раздачи с этого сайта. Он открывается в оцифровавшем его учреждении.' }
  };
